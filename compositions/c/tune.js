...
function process(output) {
  ...
  const out = Module.ccall("process", "number", ["number", "number"], [buffer, output.length])
  console.log("process!", buffer, out)
